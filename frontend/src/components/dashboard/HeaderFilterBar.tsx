  ...
  return <>
    <header className="flex flex-col gap-5 border-b border-white/[0.06] pb-6 xl:flex-row xl:items-end xl:justify-between" data-testid="dashboard-header">
      <div className="pl-12 lg:pl-0" data-testid="dashboard-title-info">
        <div className="mb-3 flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.2em] text-[#69C7F5]" data-testid="dashboard-breadcrumb"><span className="size-1.5 rounded-full bg-[#69C7F5] shadow-[0_0_8px_#69C7F5]" /> SUPPLY CHAIN / OVERVIEW</div>
